<img alt="interface-web" title="interface-web" src=".github/assets/gifs/menu-dropdown.gif" width="900"/>

## :large_blue_circle: Sobre
O projeto tem o objetivo de representar um modelo de menu dropdown.
